...
def create_database(database_type,database_password,database_name,database_user):
    if database_type == "mariadb" or database_type == "mysql":
        ...
        subprocess.call("ls",cwd=f"/home/arnau/Desktop/{database_name}")
        subprocess.call("cat docker-compose.yml",cwd=f"/home/arnau/Desktop/{database_name}")
...
create_database("mariadb","a123","arnau","mohamed")
